 ...
 */
struct dirnode * dirnode_from_file(const sds file_path);
...
const encoded_fname_t * dirnode_add_alias(struct dirnode * dn, sds fname,
...
const encoded_fname_t * dirnode_rename(struct dirnode * dn, const sds oldname,
