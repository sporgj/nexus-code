...
static struct ucafs_mod   ucafs_device;
struct ucafs_mod        * dev = &ucafs_device;
...
static int
ucafs_release(struct inode * inode,
	      struct file  * fp)
{
...
static int
ucafs_mmap_fault(struct vm_area_struct * vma,
...
static struct file_operations ucafs_mod_fops = {
    .owner          = THIS_MODULE,
    .unlocked_ioctl = ucafs_ioctl,
    .open           = ucafs_open,
    .release        = ucafs_release,
    .mmap           = ucafs_mmap,
    .write          = ucafs_write,
    .read           = ucafs_read
};
