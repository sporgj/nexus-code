...
/* Push a string on the top of the stack.  The string may contain
   zeros. */
DATALOG_API int
dl_pushlstring(dl_db_t db, const char * s, size_t n);

/* Push a string on the top of the stack.  The string must be zero
   terminated. */
DATALOG_API int
dl_pushstring(dl_db_t db, const char * s);
...
DATALOG_API int
dl_ask(dl_db_t db, dl_answers_t * a);
...
typedef void (*dl_loaderror_t)(void * data, int lineno, int colno, const char * msg);
...
DATALOG_API int
dl_load(dl_db_t database, dl_reader_t reader, dl_loaderror_t loaderror, void * data);

/* A loader for a program contained in a single buffer. */
DATALOG_API int
dl_loadbuffer(dl_db_t database, const char * buffer, size_t size, dl_loaderror_t loaderror);
...
DATALOG_API char *
dl_putlconst(char * ptr, const char * s, size_t n, int * left);

/* Print a zero terminated constant. */
DATALOG_API char *
dl_putconst(char * ptr, const char * s, int * left);
